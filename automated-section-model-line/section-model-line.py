...
# Change this to the interested earthquake station (it'll be highlighted in the graph)
STATION = {
    "network": "AM",
    "code": "R21C3",
    "lat": 13.7207,
...
#TODO make this more flexible (make it so it can run on both main dir and the dir of the file)
